        ...
        static int Main(string[] args)
        {
            ...
            using (StreamReader sr = File.OpenText(in_path2))
            {
                ...
                if (line_cnt != nbr_vehicles1)
                {
                    ...
                    //Console.WriteLine("Mismatch in reported and actual rows for file1: Reported: " + nbr_vehicles2 + " actual: " + line_cnt);
                }
            ...
            if (nbr_vehicles1 <= nbr_vehicles2)
            {
                foreach (KeyValuePair<string, Vehicle> kvp in mrlist_1)
                {
                    ...
                    {
                        missing2 += "---------------------  Missing in Vehicle reg.nr: " + kvp.Value.regnbr + " In file 2 :" + in_path2 + "   --------------------" + Environment.NewLine;
                        missing2 += "Input 1 :" + "2;" + kvp.Value.regnbr + ";" + kvp.Value.land + ";" + kvp.Value.euroclass + ";" + kvp.Value.fuel + ";" + kvp.Value.hybrid + ";" + kvp.Value.allowed_weight + ";" + kvp.Value.vehicle_group + ";" + kvp.Value.colour + ";" + kvp.Value.brand + ";" + kvp.Value.model + ";" + kvp.Value.regyear + ";" + kvp.Value.length + Environment.NewLine;
                    }
                }//Foreach
                foreach (KeyValuePair<string, Vehicle> kvp2 in mrlist_2)
                {
                    ...
                    { //Vehicle not found                     }
                        missing1 += "---------------------  Missing in Vehicle reg.nr: " + kvp2.Value.regnbr + " In file 1 :" + in_path1 + "   --------------------" + Environment.NewLine;
                        missing1 += "Input 2 :" + "2;" + kvp2.Value.regnbr + ";" + kvp2.Value.land + ";" + kvp2.Value.euroclass + ";" + kvp2.Value.fuel + ";" + kvp2.Value.hybrid + ";" + kvp2.Value.allowed_weight + ";" + kvp2.Value.vehicle_group + ";" + kvp2.Value.colour + kvp2.Value.brand + ";" + kvp2.Value.model + ";" + kvp2.Value.regyear + ";" + kvp2.Value.length + Environment.NewLine;
                    }
                }//Foreach
            }
            else
            {
                foreach (KeyValuePair<string, Vehicle> kvp in mrlist_2)
                {
                    ...
                    {
                        missing1 += "---------------------  Missing in Vehicle reg.nr: " + kvp.Value.regnbr + " In file 1 :" + in_path1 + "   --------------------" + Environment.NewLine;
                        missing1 += "Input 2 :" + "2;" + kvp.Value.regnbr + ";" + kvp.Value.land + ";" + kvp.Value.euroclass + ";" + kvp.Value.fuel + ";" + kvp.Value.hybrid + ";" + kvp.Value.allowed_weight + ";" + kvp.Value.vehicle_group + ";" + kvp.Value.colour + ";" + kvp.Value.brand + ";" + kvp.Value.model + ";" + kvp.Value.regyear + ";" + kvp.Value.length + Environment.NewLine;
                    }
                }//Foreach
                foreach (KeyValuePair<string, Vehicle> kvp2 in mrlist_1)
                {
                    ...
                    { //Vehicle not found                     
                        ...
                        missing2 += "Input 1 :" + "2;" + kvp2.Value.regnbr + ";" + kvp2.Value.land + ";" + kvp2.Value.euroclass + ";" + kvp2.Value.fuel + ";" + kvp2.Value.hybrid + ";" + kvp2.Value.allowed_weight + ";" + kvp2.Value.vehicle_group + ";" + kvp2.Value.colour + ";" + kvp2.Value.brand + ";" + kvp2.Value.model + ";" + kvp2.Value.regyear + ";" + kvp2.Value.length + Environment.NewLine;
                    }
                }//Foreach
            }
            using (StreamWriter sw = File.AppendText(out_path))
            ...
            Console.WriteLine("Finished comparing data, see result in: " + out_path);
            return 0;
        }//Main
    }//Program
} //Namespace
